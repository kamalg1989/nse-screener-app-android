...
// Parallel fetching with concurrency limit (3 for Expo - 5 may be too much for mobile context)
async function fetchWithConcurrency(
  symbols: string[],
  purpose: "screening" | "weekly_chart" = "screening",
  concurrency: number = 3  // Reduced from 5 to 3 for better mobile performance
...
export async function fetchAllStockData(
  ...
  return fetchWithConcurrency(symbols, purpose, 3)  // Use 3 concurrent for Expo
}
