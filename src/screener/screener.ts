...
export async function runScreener(
  ...
  console.log('🔍 [SCREENER] Starting screener')
  ...
  const alerts: Alert[] = []
  let filterStats = { total: 0, bars: 0, liquidity: 0, ema: 0, atr: 0, rr: 0, success: 0 }
  ...
  console.log('📊 [SCREENER] Stats:', filterStats)
  console.log('🎯 [SCREENER] Final opportunities:', alerts.length)
  console.log('🔍 [SCREENER] ========================================\n')
